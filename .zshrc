...
source /home/cibersecurity/powerlevel10k/powerlevel10k.zsh-theme
...
export PATH=/opt/kitty/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/usr/sbin/:/opt/nvim/nvim/bin
...
function settarget(){
    ip_address=$1
    machine_name=$2
    echo "$ip_address $machine_name" > /home/cibersecurity/.config/bin/target
}

# Clear Victim Target

function cleartarget(){
    echo '' > /home/cibersecurity/.config/bin/target
}
